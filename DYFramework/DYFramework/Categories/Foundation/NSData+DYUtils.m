...
- (NSString *)dy_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)dy_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)dy_hmacMD5StringWithKey:(NSString *)key {
    return [self dy_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)dy_hmacMD5DataWithKey:(NSData *)key {
    return [self dy_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)dy_hmacSHA1StringWithKey:(NSString *)key {
    return [self dy_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)dy_hmacSHA1DataWithKey:(NSData *)key {
    return [self dy_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)dy_hmacSHA224StringWithKey:(NSString *)key {
    return [self dy_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)dy_hmacSHA224DataWithKey:(NSData *)key {
    return [self dy_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)dy_hmacSHA256StringWithKey:(NSString *)key {
    return [self dy_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)dy_hmacSHA256DataWithKey:(NSData *)key {
    return [self dy_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)dy_hmacSHA384StringWithKey:(NSString *)key {
    return [self dy_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)dy_hmacSHA384DataWithKey:(NSData *)key {
    return [self dy_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)dy_hmacSHA512StringWithKey:(NSString *)key {
    return [self dy_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)dy_hmacSHA512DataWithKey:(NSData *)key {
    return [self dy_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)dy_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)dy_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
+ (NSData *)dy_dataWithHexString:(NSString *)hexStr {
...
+ (NSData *)dy_dataWithBase64EncodedString:(NSString *)base64EncodedString {
...
+ (NSString *)dy_creatMD5StringWithString:(NSString *)string
{
...
+ (NSString *)dy_creatDataPathWithString:(NSString *)string
{
    NSString *path = [NSData dy_cachePath];
    path = [path stringByAppendingPathComponent:[self dy_creatMD5StringWithString:string]];
    return path;
}

- (void)dy_saveDataCacheWithIdentifier:(NSString *)identifier
{
    NSString *path = [NSData dy_creatDataPathWithString:identifier];
...
+ (NSData *)dy_getDataCacheWithIdentifier:(NSString *)identifier
{
    ...
    if (!isCheckedCacheDisk) {
        ...
        NSArray *contents = [manager contentsOfDirectoryAtPath:[self dy_cachePath] error:nil];
        if (contents.count >= kSDMaxCacheFileAmount) {
            [manager removeItemAtPath:[self dy_cachePath] error:nil];
        }
        isCheckedCacheDisk = YES;
    }
    NSString *path = [self dy_creatDataPathWithString:identifier];
